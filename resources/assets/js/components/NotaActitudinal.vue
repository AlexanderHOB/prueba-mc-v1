                                ...
                                <tbody>
                                    <tr v-for="estudiante in arrayEstudiante" :key="estudiante.id" >
                                        ...
                                        <td v-for="(nota,index) in estudiante.nota" :key="nota.id">
                                            <select class="form-control" v-model="estudiante.nota[index]">
        ...
        methods:{
            ...
            registrarNota(){
             ...
             validarNota(){
                ...
                //     if(this.arrayEstudiante[i]['promedio']==undefined) this.errorMostrarMsjNota.push("Inserte Nota en el registro Nº"+i);
                // }
