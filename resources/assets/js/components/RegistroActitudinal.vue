    ...
    export default {
        ...
        methods:{
            cargarPdf(idestudiante){
                window.open(this.ruta+'/estudiante/listarboletaprimero?idestudiante='+idestudiante ,'_blank');
            },
            ...
            selectSalones(){
                let me=this;
                var url=this.ruta+'/getSalonProfesor/actitudinal';
                axios.get(url).then(function (response) {
            ...
            getIdCurso(buscar,criterio){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.buscarEstudiantes(1,me.idsalon,me.idcurso);
                })        
                .catch(function (error) {
                    // handle error
                    console.log(error);
            ...
            buscarEstudiantes(page,buscar,buscar1){
                let me=this;
                var url=this.ruta+'/estudiante/nota?page=' + page + '&buscar='+ buscar + '&buscar1='+buscar1;
                axios.get(url).then(function (response) {
                    ...
                    for(let i = 0 ; i<me.arrayEstudiante.length;i++){
                        me.arrayEstudiante[i]['calificacion']=me.arrayEstudiante[i]['calificacion'].split(',',numsplit);
                    }
